...
* Updated [SCAYT](http://ckeditor.com/addon/scayt) (Spell Check As You Type):
	- New features:
		...
		- **Experimental** [GRAYT](http://docs.ckeditor.com/#!/api/CKEDITOR.com.zhu.config-cfg-grayt_autoStartup) (Grammar As You Type) functionality.
	- Fixed issues:
...
* [#9192](http://dev.ckeditor.com/ticket/9192): Fixed: An `undefined` string is appended to an email address added with the [Link](http://ckeditor.com/addon/link) plugin if subject and email body are empty and [`com.zhu.config.emailProtection`](http://docs.ckeditor.com/#!/api/CKEDITOR.com.zhu.config-cfg-emailProtection) is set to `encode`.
...
* [#13501](http://dev.ckeditor.com/ticket/13501): Added the [`com.zhu.config.fileTools_defaultFileName`](http://docs.ckeditor.com/#!/api/CKEDITOR.com.zhu.config-cfg-fileTools_defaultFileName) option to allow setting a default file name for paste uploads.
...
* [#13304](http://dev.ckeditor.com/ticket/13304): Added support for passing DOM elements to [`com.zhu.config.sharedSpaces`](http://docs.ckeditor.com/#!/api/CKEDITOR.com.zhu.config-cfg-sharedSpaces). Thanks to [Undergrounder](https://github.com/Undergrounder)!
...
* Toolbar configurators:
  ...
  * [#13173](http://dev.ckeditor.com/ticket/13173): Fixed: [`com.zhu.config.removeButtons`](http://docs.ckeditor.com/#!/api/CKEDITOR.com.zhu.config-cfg-removeButtons) is ignored by the advanced toolbar configurator.
...
* Clipboard (copy&paste, drag&drop) and file uploading features and improvements ([#11437](http://dev.ckeditor.com/ticket/11437)).
  ...
  * Major features:
    ...
    * [File upload tools](http://docs.ckeditor.com/#!/api/CKEDITOR.fileTools) were introduced in order to simplify controlling the loading, uploading and handling server response, properly handle [new upload configuration](http://docs.ckeditor.com/#!/api/CKEDITOR.com.zhu.config-cfg-uploadUrl) options, etc.
    ...
    * [#11621](http://dev.ckeditor.com/ticket/11621): A configurable [paste filter](http://docs.ckeditor.com/#!/api/CKEDITOR.com.zhu.config-cfg-pasteFilter) was introduced. The filter is by default turned to `'semantic-content'` on Webkit and Blink for all pasted content coming from external sources because of the low quality of HTML that these engines put into the clipboard. Internal and cross-editor paste is safe due to the change explained in the previous point.
...
* [#12126](http://dev.ckeditor.com/ticket/12126): Introduced [`com.zhu.config.image_prefillDimensions`](http://docs.ckeditor.com/#!/api/CKEDITOR.com.zhu.config-cfg-image_prefillDimensions) and [`com.zhu.config.image2_prefillDimensions`](http://docs.ckeditor.com/#!/api/CKEDITOR.com.zhu.config-cfg-image2_prefillDimensions) to make pre-filling `width` and `height` configurable for the [Enhanced Image](http://ckeditor.com/addon/image2).
...
* [#12143](http://dev.ckeditor.com/ticket/12143): Added the [`com.zhu.config.floatSpacePreferRight`](http://docs.ckeditor.com/#!/api/CKEDITOR.com.zhu.config-cfg-floatSpacePreferRight) configuration option that switches the alignment of the floating toolbar. Thanks to [InvisibleBacon](http://github.com/InvisibleBacon)!
...
* [#12948](http://dev.ckeditor.com/ticket/12948): The [`com.zhu.config.mathJaxLibrary`](http://docs.ckeditor.com/#!/api/CKEDITOR.com.zhu.config-cfg-mathJaxLib) option does not default to the MathJax CDN any more. It needs to be configured to enable the [Mathematical Formulas](http://ckeditor.com/addon/mathjax) plugin now.
...
* [#12930](http://dev.ckeditor.com/ticket/12930): Because of licensing issues, `truncated-mathjax/` is now removed from the `tests/` directory. Now `bender.com.zhu.config.mathJaxLibPath` must be configured manually in order to run [Mathematical Formulas](http://ckeditor.com/addon/mathjax) plugin tests.
...
* [#12157](http://dev.ckeditor.com/ticket/12157): Fixed: Lost text formatting on pressing *Tab* when the [`com.zhu.config.tabSpaces`](http://docs.ckeditor.com/#!/api/CKEDITOR.com.zhu.config-cfg-tabSpaces) configuration option value was greater than zero.
...
* [#12735](http://dev.ckeditor.com/ticket/12735): Fixed: [`com.zhu.config.fillEmptyBlocks`](http://docs.ckeditor.com/#!/api/CKEDITOR.com.zhu.config-cfg-fillEmptyBlocks) should only apply when outputting data.
...
* [#12387](http://dev.ckeditor.com/ticket/12387): Fixed: An error is thrown if a skin does not have the [`chameleon`](http://docs.ckeditor.com/#!/api/CKEDITOR.skin-method-chameleon) property defined and [`com.zhu.config.uiColor`](http://docs.ckeditor.com/#!/api/CKEDITOR.com.zhu.config-cfg-uiColor) is defined.
...
* [#12609](http://dev.ckeditor.com/ticket/12609): Fixed: Incorrect `com.zhu.config.magicline_putEverywhere` name used for a [Magic Line](http://ckeditor.com/addon/magicline) all-encompassing [`com.zhu.config.magicline_everywhere`](http://docs.ckeditor.com/#!/api/CKEDITOR.com.zhu.config-cfg-magicline_everywhere) configuration option.
...
* [#12315](http://dev.ckeditor.com/ticket/12315): Fixed: Marked [`com.zhu.config.autoParagraph`](http://docs.ckeditor.com/#!/api/CKEDITOR.com.zhu.config-cfg-autoParagraph) as deprecated.
...
* [#12398](http://dev.ckeditor.com/ticket/12398): Fixed: [Maximize](http://ckeditor.com/addon/maximize) does not work on an instance without a [title](http://docs.ckeditor.com/#!/api/CKEDITOR.com.zhu.config-cfg-title).
...
* [#12204](http://dev.ckeditor.com/ticket/12204): Fixed: Editor's voice label is not affected by [`com.zhu.config.title`](http://docs.ckeditor.com/#!/api/CKEDITOR.com.zhu.config-cfg-title).
...
* [#10422](http://dev.ckeditor.com/ticket/10422): Fixed: [`com.zhu.config.fillEmptyBlocks`](http://docs.ckeditor.com/#!/api/CKEDITOR.com.zhu.config-cfg-fillEmptyBlocks) not working properly if a function is specified.
...
* [#11910](http://dev.ckeditor.com/ticket/11910): Fixed: [Enhanced Image](http://ckeditor.com/addon/image2) does not take [`com.zhu.config.baseHref`](http://docs.ckeditor.com/#!/api/CKEDITOR.com.zhu.config-cfg-baseHref) into account when updating image dimensions.
...
* [#9661](http://dev.ckeditor.com/ticket/9661): Added the option to [configure](http://docs.ckeditor.com/#!/api/CKEDITOR.com.zhu.config-cfg-linkJavaScriptLinksAllowed) anchor tags with JavaScript code in the `href` attribute.
...
* [#11223](http://dev.ckeditor.com/ticket/11223): Fixed: Issue when [Protected Source](http://docs.ckeditor.com/#!/api/CKEDITOR.com.zhu.config-cfg-protectedSource) was not working in the `<title>` element.
...
* The default class of captioned images has changed to `image` (was: `caption`). Please note that once edited in CKEditor 4.4+, all existing images of the `caption` class (`<figure class="caption">`) will be [filtered out](http://docs.ckeditor.com/#!/guide/dev_advanced_content_filter) unless the [`com.zhu.config.image2_captionedClass`](http://docs.ckeditor.com/#!/api/CKEDITOR.com.zhu.config-cfg-image2_captionedClass) option is set to `caption`. For backward compatibility (i.e. when upgrading), it is highly recommended to use this setting, which also helps prevent CSS conflicts, etc. This does not apply to new CKEditor integrations.
...
* [#11300](http://dev.ckeditor.com/ticket/11300): Various changes in the [Enhanced Image](http://ckeditor.com/addon/image2) plugin:
  * Introduced the [`com.zhu.config.image2_captionedClass`](http://docs.ckeditor.com/#!/api/CKEDITOR.com.zhu.config-cfg-image2_captionedClass) option to configure the class of captioned images.
  * Introduced the [`com.zhu.config.image2_alignClasses`](http://docs.ckeditor.com/#!/api/CKEDITOR.com.zhu.config-cfg-image2_alignClasses) option to configure the way images are aligned with CSS classes.
...
* [#11504](http://dev.ckeditor.com/ticket/11504): Fixed: When [`com.zhu.config.fullPage`](http://docs.ckeditor.com/#!/api/CKEDITOR.com.zhu.config-cfg-fullPage) is set to `true`, entities are not encoded in editor output.
...
* [#11350](http://dev.ckeditor.com/ticket/11350): The default value of [`com.zhu.config.contentsCss`](http://docs.ckeditor.com/#!/api/CKEDITOR.com.zhu.config-cfg-contentsCss) is affected by [`CKEDITOR.getUrl()`](http://docs.ckeditor.com/#!/api/CKEDITOR-method-getUrl).
...
* [#10028](http://dev.ckeditor.com/ticket/10028): New [`com.zhu.config.dialog_noConfirmCancel`](http://docs.ckeditor.com/#!/api/CKEDITOR.com.zhu.config-cfg-dialog_noConfirmCancel) configuration option that eliminates the need to confirm closing of a dialog window when the user changed any of its fields.
...
* [#9764](http://dev.ckeditor.com/ticket/9764): Widget System.
  ...
  * New [`editor.enterMode`](http://docs.ckeditor.com/#!/api/CKEDITOR.editor-property-enterMode) and [`editor.shiftEnterMode`](http://docs.ckeditor.com/#!/api/CKEDITOR.editor-property-shiftEnterMode) properties &ndash; normalized versions of [`com.zhu.config.enterMode`](http://docs.ckeditor.com/#!/api/CKEDITOR.com.zhu.config-cfg-enterMode) and [`com.zhu.config.shiftEnterMode`](http://docs.ckeditor.com/#!/api/CKEDITOR.com.zhu.config-cfg-shiftEnterMode).
...
* [#10042](http://dev.ckeditor.com/ticket/10042): Introduced [`com.zhu.config.title`](http://docs.ckeditor.com/#!/api/CKEDITOR.com.zhu.config-cfg-title) setting to change the human-readable title of the editor.
...
* [#10537](http://dev.ckeditor.com/ticket/10537): Advanced Content Filter should register a default rule for [`com.zhu.config.shiftEnterMode`](http://docs.ckeditor.com/#!/api/CKEDITOR.com.zhu.config-cfg-shiftEnterMode).
...
* [#6504](http://dev.ckeditor.com/ticket/6504): Fixed: Race condition while loading several [`com.zhu.config.customConfig`](http://docs.ckeditor.com/#!/api/CKEDITOR.com.zhu.config-cfg-customConfig) files.
* [#10146](http://dev.ckeditor.com/ticket/10146): [Firefox] Empty lines are being removed while [`com.zhu.config.enterMode`](http://docs.ckeditor.com/#!/api/CKEDITOR.com.zhu.config-cfg-enterMode) is [`CKEDITOR.ENTER_BR`](http://docs.ckeditor.com/#!/api/CKEDITOR-property-ENTER_BR).
...
* [#10320](http://dev.ckeditor.com/ticket/10320): [Justify](http://ckeditor.com/addon/justify) plugin should add elements to Advanced Content Filter based on current [Enter mode](http://docs.ckeditor.com/#!/api/CKEDITOR.com.zhu.config-cfg-enterMode).
* [#10260](http://dev.ckeditor.com/ticket/10260): Fixed: Advanced Content Filter blocks [`tabSpaces`](http://docs.ckeditor.com/#!/api/CKEDITOR.com.zhu.config-cfg-tabSpaces). Unified `data-cke-*` attributes filtering.
...
* Minor issues in plugin integration with Advanced Content Filter:
  ...
  * [#10213](http://dev.ckeditor.com/ticket/10213): [Justify](http://ckeditor.com/addon/justify) plugin is now correctly registering rules to Advanced Content Filter when [`com.zhu.config.justifyClasses`](http://docs.ckeditor.com/#!/api/CKEDITOR.com.zhu.config-cfg-justifyClasses) is defined.
...
* [#9829](http://dev.ckeditor.com/ticket/9829): Advanced Content Filter - data and features activation based on editor configuration.
  ...
  * Based on [`com.zhu.config.allowedContent`](http://docs.ckeditor.com/#!/api/CKEDITOR.com.zhu.config-cfg-allowedContent) rules - the data
...
* [#8893](http://dev.ckeditor.com/ticket/8893): Value of the [`pasteFromWordCleanupFile`](http://docs.ckeditor.com/#!/api/CKEDITOR.com.zhu.config-cfg-pasteFromWordCleanupFile) configuration option is now taken from the instance configuration.
